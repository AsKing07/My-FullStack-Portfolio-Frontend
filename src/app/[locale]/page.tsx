            ...
            <div className="flex-1 space-y-8 animate-in slide-in-from-left duration-1000">
              ...
              <div className="space-y-2">
                ...
                <div className="text-2xl md:text-3xl font-bold text-gray-700 dark:text-gray-300">
                  <span className="typing-animation">{t('hero.role')}</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 pt-6 text-sm text-gray-600 dark:text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span>{t('hero.availableForOpportunities')}</span>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {getTechArray(proj.technologies).length > 3 && (
                          <Badge variant="outline" className="text-xs">
                            {t('projects.moreTech', { count: getTechArray(proj.technologies).length - 3 })}
                          </Badge>
                        )}
                      </div>
                      <div className="line-clamp-3 text-gray-700 dark:text-gray-300">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2 mb-12 max-w-4xl mx-auto">
              {(() => {
                ...
                post ? (
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-center gap-2 text-sm text-green-600 dark:text-green-400 mb-2">
                        ...
                        <span className="font-medium">
                          {t('blog.published', { date: formatDate(post.publishedAt) })}
                        </span>
                      </div>
                  ...
                  <Card key={`blog-skeleton-${i}`} className="h-56">
                    <div className="p-6 space-y-4">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                {t('cta.titlePrefix')}{" "}
                <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">{t('cta.titleHighlight')}</span> ?
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16 max-w-3xl mx-auto">
                ...
                <div className="text-center">
                  ...
                  <div className="text-blue-200 text-sm">{t('cta.statsClients')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-white mb-2">4+</div>
                  <div className="text-blue-200 text-sm">{t('cta.statsExperience')}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {user && (
        <>
          ...
          <WebsiteSchema
            ...
            url={process.env.NEXT_PUBLIC_APP_URL || ""}
            description={t('hero.websiteSchemaDescription')}
