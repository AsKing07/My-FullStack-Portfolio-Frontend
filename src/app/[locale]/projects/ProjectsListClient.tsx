...
import { ExternalLink, Github, Figma, Calendar, Layers, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-6 text-sm text-gray-600 dark:text-gray-400">
          {t("showingRange", { start: startIndex + 1, end: Math.min(endIndex, totalProjects), total: totalProjects })}
          {selectedCategory && t("inCategory", { category: selectedCategory })}
        </div>
      </div>
    </div>
  );
