...
export default function ProjectEditPage() {
    ...
    async function fetchProject() {
      ...
      try {
        ...
        form.reset({
          ...
          image: project.image || '',
          gallery: project.gallery ? project.gallery.split(',').filter(Boolean) : [],
          technologies: project.technologies || '',
          startDate: project.startDate ? new Date(project.startDate) : undefined,
          endDate: project.endDate ? new Date(project.endDate) : undefined,
          categoryId: project.category?.id || '',
        });
        setMainImageUrl(project.image || '');
        setGalleryUrls(project.gallery ? project.gallery.split(',').filter(Boolean) : []);
      } catch (err) {
  ...
  const handleGalleryChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      if (urls && urls.length > 0) {
        ...
        form.setValue('gallery', [...(form.getValues('gallery') || []), ...urls]);
      }
    } catch (error) {
      toast.error(`Erreur lors du téléchargement de la galerie`);
    }
  };
  ...
  if (loadingCategory || loadingProject) {
    return (
              ...
              <CardContent className="space-y-6">
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Select.Root
                    ...
                    onValueChange={(val: string) => form.setValue('categoryId', val)}
                  >
                    <Select.Trigger placeholder={form.getValues('categoryId') || 'Sélectionner une catégorie'} />
                    <Select.Content>
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={(val: boolean | "indeterminate") => form.setValue('featured', !!val)}
                  />
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <Input {...form.register('technologies')} placeholder="ex: React, Node.js, Tailwind" />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className='flex flex-col gap-2'>
                    ...
                    <DatePicker
                      ...
                      onChange={(date: Date | null) => form.setValue('startDate', date || undefined)}
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  >
                    <Select.Trigger placeholder={form.getValues('status') || 'Sélectionner un statut'} />
                    <Select.Content>
                  ...
                  {mainImageUrl && (
                    <div className="mt-2">
                      <Image
                        ...
                        width={320}
                        height={192}
                        style={{ objectFit: 'cover', maxHeight: '12rem', width: 'auto' }}
                      />
                    </div>
                  )}
                </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {galleryUrls.map((url, i) => (
                      <div key={url} className="relative group">
                        <Image width={320} height={192} src={url} alt={`Galerie ${i + 1}`} className="rounded-lg h-20 w-32 object-cover" />
                        <button
                          type="button"
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <Input {...form.register('liveUrl')} placeholder="https://exemple.com" />
                </div>
                <div>
                  <label className="font-semibold flex items-center gap-2">
                ...
                <div>
                  ...
                  <Input {...form.register('figmaUrl')} placeholder="https://figma.com/..." />
                </div>
              </CardContent>
            </Card>
          </Tabs.Content>
